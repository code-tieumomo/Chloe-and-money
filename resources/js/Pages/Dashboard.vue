    ...
    <BreezeAuthenticatedLayout>
        ...
        <div v-if="false" class="max-w-7xl p-6 mx-auto">
            ...
            <Transition>
                ...
                >
                    <div
                        class="relative p-4 w-full h-full flex justify-center items-center"
                    >
                        <!-- Modal content -->
                        <div
                            class="relative bg-white rounded-lg shadow w-full max-w-md"
                            @click.stop
                        >
                            <button
                                type="button"
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            v-model="form.type"
                                        >
                                            <option value="spending" selected>
                                                Spending money
                                            </option>
                                            <option value="saving">
                                                Saving money
